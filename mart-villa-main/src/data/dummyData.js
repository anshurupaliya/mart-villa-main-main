...
export const services = [
  {
    ...
    text: "We aim to provide you with an unmatched living experience, whether you're looking for a short-term rental or a forever home.",
  },
  {
    id: 2,
    name: "architectural design",
    icon: <BiFullscreen />,
    text: "Our architectural design services focus on creating bespoke spaces that reflect your vision. ",
  },
  {
    id: 3,
    name: "extra security",
    icon: <BiShieldAlt2 />,
    text: "Safety is a top priority. We offer enhanced security solutions for your property, including CCTV surveillance, smart access controls, and 24/7 monitoring.",
  },
  {
    id: 4,
    ...
    // icon: <BiHomeAlt />,
    icon: <BiWater />,
    text: "We ensure an uninterrupted water supply, 24 hours a day, for your convenience.",
  },
  {
    id: 5,
    name: "Fully Automatic Lifts",
    icon: <FaPaintRoller />,
    text: "Experience the convenience of fully automatic lifts in our properties.",
  },
  {
    id: 6,
    name: "24/7 support",
    icon: <FiHeadphones />,
    text: "We are always here for you. Our dedicated support team is available around the clock to address any concerns, answer questions, or provide assistance. .",
  },
];
...
export const faqs = [
  {
    ...
    response:
      "We offer a wide range of real estate services including luxury apartments, architectural design, extra security, home remodeling, office renovation, 24/7 support, fully automatic lifts, and 24-hour water supply. Our goal is to provide a one-stop solution for all your real estate needs.",
  },
  {
    id: 2,
    question: "How can I start the home buying process?",
    response:
      "Starting the home buying process is easy! Contact us to schedule a consultation. We'll discuss your needs, preferences, and budget, and then we’ll help you find suitable properties. We guide you through each step, from property selection to closing.",
  },
  {
    id: 3,
    question: "What should I look for when buying a property?",
    response:
      "When buying a property, consider factors such as location, property size, amenities, and condition. Also, evaluate your long-term needs and budget. Our experienced agents can help you assess these factors and find a property that meets your criteria.",
  },
  {
    id: 4,
    question: "What are the benefits of working with a real estate agent?",
    response:
      "Working with a real estate agent provides numerous benefits, including expert market knowledge, access to a wider range of properties, skilled negotiation, and assistance with paperwork. Our agents are dedicated to ensuring a smooth and successful transaction.",
  },
  {
    id: 5,
    question: "Are your properties inspected before listing?",
    response:
      "Yes, we ensure that all properties listed with us meet our quality standards. We recommend conducting a professional inspection to identify any potential issues before finalizing a purchase. Our team can help arrange inspections and provide guidance on any findings.",
  },
  {
    id: 6,
    question: "What should I do if I have a maintenance issue after buying a property?",
    response:
      "If you encounter maintenance issues after buying a property, contact us immediately. We can connect you with reliable contractors and service providers to address any problems. We are committed to ensuring that your new home remains in excellent condition.",
  },
];
