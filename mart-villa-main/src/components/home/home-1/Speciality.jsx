    ...
    <div className="pt-10 pb-16">
      <div className="flex flex-wrap gap-10">
        <div className="flex-1 basis-[20rem]">
          ...
          <p className="mt-3">
          As the world becomes more fast-paced, the idea of peaceful living is turning into luxury with every passing day. But what if you could still find harmony amidst the perfect balance of nature and the contemporary? At MartVilla, we make these dreams come true. So, take it slow, stop, smell the roses and bask in the happiness.
          </p>
          <div className="mt-4">
